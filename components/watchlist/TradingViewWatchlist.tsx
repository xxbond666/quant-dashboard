...
function TradingViewWatchlist({ symbols }: TradingViewWatchlistProps) {
    ...
    return (
        <div className="tradingview-widget-container border border-white/10 rounded-xl overflow-hidden shadow-2xl bg-background/40 backdrop-blur-md" ref={container}>
